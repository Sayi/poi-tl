...
public class MiniTableRenderTest {
	...
	RowRenderData header = new RowRenderData(
			Arrays.asList(new TextRenderData("FFFFFF", "姓名"), new TextRenderData("FFFFFF", "学历")), "ff9800");

	RowRenderData row0 = new RowRenderData(
			Arrays.asList(new TextRenderData("张三"), new TextRenderData("1E915D", "研究生")));
	RowRenderData row1 = new RowRenderData(
			Arrays.asList(new TextRenderData("FFFFFF", "李四"), new TextRenderData("FFFFFF", "博士")), "ff9800");
	RowRenderData row2 = new RowRenderData(
			Arrays.asList(new TextRenderData("王五"), new TextRenderData("1E915D", "博士后")));
