...
public class ResumeExampleV2 {
    ...
    public void testResumeExample() throws Exception {
        XWPFTemplate template = XWPFTemplate.compile("src/test/resources/resume/简历V2.docx").render(datas);
        
        FileOutputStream out = new FileOutputStream("out_简历V2.docx");
        template.write(out);
        out.flush();
        out.close();
        template.close();
