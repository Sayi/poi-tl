...
Java word的模板引擎，Apache POI功能增强。

# Why poi-tl

| Word处理方案 | 跨平台 | 样式处理  | 易用性
| --- | --- | --- | --- |
| **Poi-tl** | 纯Java组件，跨平台 | 不需要编码，模板即样式 | :white_check_mark: 简单：模板引擎功能，基于Apache POI并进行了增强封装
| Apache POI | 纯Java组件，跨平台 | 编码 | :white_check_mark: 简单
...
Poi-tl(poi template language)主要提供了如下特性：
* **Word模板引擎**
* 多个Word文档合并
* 合并单元格
* Word指定位置插入表格、图片、段落
