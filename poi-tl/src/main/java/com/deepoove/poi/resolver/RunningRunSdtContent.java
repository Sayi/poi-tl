...
// * @version
// */
//public class RunningRunSdtContent {
//
//    private static final Logger LOG = LoggerFactory.getLogger(RunningRunSdtContent.class);
//
...
//
//    public RunningRunSdtContent(XWPFStructuredDocumentTagContent sdtContent, Pattern pattern) {
//        this.sdtContent = sdtContent;
//        this.runs = sdtContent.getRuns();
//        if (null == runs || runs.isEmpty()) return;
//
//        Matcher matcher = pattern.matcher(getParagraphText(sdtContent));
//        if (matcher.find()) {
//            refactorParagraph();
//        }
//
...
//    }
//
//    private String getParagraphText(XWPFStructuredDocumentTagContent sdtContent) {
...
//                if (startRunPos != endRunPos) sdtContent.removeRun(endRunPos);
//            } else {
...
//                    XWPFRun extraRun = sdtContent.insertNewRun(endRunPos + 1);
...
//                buildExtra(extra, extraRun);
//
//                XWPFRun templateRun = sdtContent.insertNewRun(startRunPos + 1);
...
//                            XWPFRun insertNewRun = sdtContent.insertNewRun(i + 1);
